export const MESSAGE_SCROLL_HIGHLIGHT_CLASS =
  "conversation-message-scroll-highlight";
...
export const scrollMessageAnchorIntoView = (
  ...
  try {
    ...
    const prev = scrollRoot.querySelector<HTMLElement>(
