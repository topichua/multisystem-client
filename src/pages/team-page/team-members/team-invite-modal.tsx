    ...
    >
      ...
      >
        <S.NameFields>
          <Form.Item
            name="firstName"
            label={t("team.invite.firstName")}
            rules={[
              { required: true, message: t("team.invite.firstNameRequired") },
            ]}
          >
            <Input
          ...
          <Form.Item
            name="lastName"
            label={t("team.invite.lastName")}
            rules={[
              { required: true, message: t("team.invite.lastNameRequired") },
            ]}
          >
            <Input placeholder={t("team.invite.lastNamePlaceholder")} />
          </Form.Item>
        </S.NameFields>
