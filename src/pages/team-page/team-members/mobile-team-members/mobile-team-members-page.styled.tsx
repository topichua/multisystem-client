...
export const Root = styled.div.attrs(() =>
  dataQaAttrs("team-mobile-members-page"),
)`
...
export const InviteButtonLabel = styled.span`
...
export const MemberIdentityWrap = styled.div`
  min-width: 0;
  flex: 1 1 auto;
`;
...
export const JoinedText = styled(Typography.Text)`
  && {
    color: ${({ theme }) => theme.colors.functional.text.subdued};
    font-size: ${({ theme }) => theme.fontSize.small};
    line-height: 1.25;
