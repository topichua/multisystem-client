  ...
  return (
    <>
      ...
      >
        ...
        >
          <InputNumber min={0} style={{ width: '100%' }} onBlur={blur('price')} />
        </Form.Item>
        <Form.Item
          name="currency"
          ...
          style={{ marginBottom: 0 }}
        >
          <Select options={[{ value: 'UAH', label: 'UAH' }]} onChange={change('currency')} />
        </Form.Item>
        <Form.Item
          name="inStock"
        ...
        <Form.Item
          ...
          style={{ marginBottom: 0 }}
        >
          <InputNumber min={0} style={{ width: '100%' }} onBlur={blur('quantity')} />
        </Form.Item>
      </div>
    </>
  );
