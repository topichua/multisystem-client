...
export const ProductsListToolbar = observer(({ onToggleFilters }: ProductsListToolbarProps) => {
  const { t } = useTranslation();
  const productsStore = useProductsStore();
  const [keywordDraft, setKeywordDraft] = useState(() => productsStore.listKeyword);
  ...
  return (
    <Flex align="center" gap={16} wrap="wrap" style={{ marginBottom: 16, width: '100%' }}>
