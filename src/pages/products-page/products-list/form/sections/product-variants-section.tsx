  ...
  <Card>
    <Flex vertical gap={24}>
      <Flex vertical gap={4}>
        ...
        <Text type="secondary">
          Add characteristics like color or size. Price and quantity are
          configured for each variant.
        </Text>
      </Flex>

      <Card size="small" title="Characteristics">
                ...
                return (
                  <Flex key={field.key} gap={12} align="flex-start">
                    ...
                    <Form.Item
                      ...
                      rules={[{ required: true, message: "Add values" }]}
        ...
        {productVariants.length === 0 ? (
          ...
          >
            <Text type="secondary" style={{ textAlign: "center" }}>
              No variants yet. Add characteristics to generate variants
              automatically or add variant manually.
            </Text>
