...
export const Wrapper = styled.aside.attrs(() => dataQaAttrs('layout-app-sider'))`
  padding: 8px 0;
  width: fit-content;
  height: 100%;
...
export const MenuSider = styled.div.attrs(() => dataQaAttrs('layout-app-sider-nav'))<{
  $showLabel: boolean;
}>`
  width: max-content;
  display: flex;
  ...
  &&&&& .ant-btn {
    ...
    &:hover {
      border-color: ${(props) => props.theme.colors.functional.border.primary}!important;
    }

    &.active,
    &:active,
    &:focus {
      background-color: ${(props) => props.theme.colors.brandPalette[1]}!important;
      border-color: ${(props) => props.theme.colors.functional.border.selected}!important;
...
export const MenuSiderPanel = styled.div.attrs(() => dataQaAttrs('layout-app-sider-panel'))<{
...
export const SiderScrollArea = styled.div.attrs(() => dataQaAttrs('layout-app-sider-scroll'))`
  flex: 1;
  min-height: 0;
  overflow-x: hidden;
  overflow-y: auto;
...
export const SiderFooter = styled.div.attrs(() => dataQaAttrs('layout-app-sider-footer'))`
  flex-shrink: 0;
  margin-top: auto;
  padding: 8px 8px 0;
  display: flex;
...
export const Brand = styled.div.attrs(() => dataQaAttrs('layout-app-sider-brand'))<{
  $showLabel: boolean;
}>`
  padding: 8px;
  height: 48px;
  ...
  &:focus-visible {
    outline: 2px solid ${(props) => props.theme.colors.functional.border.selected};
    outline-offset: 2px;
  }
`;
