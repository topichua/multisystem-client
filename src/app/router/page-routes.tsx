    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route path={pagesMap.home} element={<HomePage />}>
          <Route index element={<Navigate to={pagesMap.conversations} replace />} />
          <Route path="conversations" element={<ConversationsPage />}>
            <Route index element={<EmptyConversation />} />
            <Route path=":conversationId" element={<ConversationDetails />} />
          </Route>
          <Route path="settings" element={<SettingsPage />}>
            <Route index element={<Navigate to={pagesMap.settingsGroups} replace />} />
          ...
          <Route path="products" element={<ProductsPage />}>
            <Route index element={<Navigate to={pagesMap.productsList} replace />} />
            <Route path="list/add" element={<ProductAddPage />} />
            <Route path="list/product/:productId" element={<ProductAddPage />} />
            ...
            <Route path="categories" element={<ProductsCategoriesLayout />}>
              ...
              <Route path=":categoryId" element={<ProductCategoryDetailView />} />
            </Route>
          </Route>
          <Route path="orders" element={<OrdersPage />}>
            <Route index element={<Navigate to={pagesMap.ordersList} replace />} />
          ...
          <Route path="clients" element={<ClientsPage />}>
            <Route index element={<Navigate to={pagesMap.clientsWorkspace} replace />} />
            <Route path="clients" element={<ClientsListPage />} />
          </Route>
        </Route>
      </Route>

      <Route path={pagesMap.fallback} element={<Navigate to={pagesMap.conversations} replace />} />
    </Routes>
  );
};
