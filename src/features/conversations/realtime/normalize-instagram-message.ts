...
export const normalizeInstagramMessage = (dto: InstagramMessageDto): ConversationMessage => ({
  id: dto.id,
  ...
  ...(dto.reactions?.data != null
    ? { reactions: { data: dto.reactions.data as Array<Record<string, unknown>> } }
    : {}),
  ...
  ...(dto.replied_to_message != null
    ? {
        replied_to_message: {
          ...
          ...(dto.replied_to_message.from != null ? { from: dto.replied_to_message.from } : {}),
        },
      }
    : {}),
});
